...
const ManageRoundWay = () => {
  ...
  const [roundWayTrip, setRoundWayTrip] = useState([]);
  ...
  const getRoundWayTrip = async () => {
    try {
      ...
      if (response.status === 200) {
        setRoundWayTrip(response.data);
      }
    } catch (err) {
      console.log(err);
      toast.error("Falied to Fetch the Round Way Trip ");
    }
  };
  ...
  const handleDelete = async (id) => {
    try {
      const response = await client.post(
        "/roundtrip/delete-roundway-trip",
        {
          id: id,
        },
        {
  ...
  const sendData=async()=>{
    try {
      ...
      if (response.status === 200) {
        toast.success("Round way Trip update Successfully");
    ...
    <main id="main" className="main">
      <div className="pagetitle">
        ...
        >
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Manage/Round Way Trip</li>
          </ol>
        </nav>
      </div>
      ...
      >
        ...
        <div className="table-responsive">
              ...
              >
                <span className="mb-2" style={{ marginBottom: "8px" }}>No Round Way Trip</span>
